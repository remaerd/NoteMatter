	...
	override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
	{
		if indexPath.section == 0
		{
			...
			case 0:
				...
				cell.titleTextfield.text = ".preferences.assistant".localized
			...
			case 1:
				...
				cell.titleTextfield.text = ".preferences.assistant.level".localized
				cell.delegate = self
		...
		else
		{
			...
			case 0:
				...
				cell.titleTextfield.text = ".preferences.assistant.rules.briefing".localized
			...
			case 1:
				...
				cell.titleTextfield.text = ".preferences.assistant.rules.lazy".localized
				cell.delegate = self
			...
			case 2:
				...
				cell.titleTextfield.text = ".preferences.assistant.rules.tooManyTasks".localized
				cell.delegate = self
			...
			case 3:
				...
				cell.titleTextfield.text = ".preferences.assistant.rules.dalay".localized
				cell.delegate = self
